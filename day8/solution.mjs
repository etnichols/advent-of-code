...
function createDecoderMap(input){
...
// Segment A can always be solved using array corresponding to number 1 (length 2)
// and number 7 (length 3), as they share 2/3 segments. "Odd one out" must be segment A.
function solveForA(mustBeOne, mustBeSeven){
